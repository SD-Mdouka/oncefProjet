...
export const index = () => {
  return (
    <>
      <div class="sc-esOvli geHgWR">
        <div class="sc-cmthru hqHjAv">
          <div class="sc-hMFtBS kSVpgy">
            <div class="sc-cLQEGU bKkcbe">
              Je planifie mes voyages à l’avance et je profite des meilleurs
              tarifs…
            </div>
            <div class="sc-gqPbQI bKNAml">
              <a
                buttonstyle="outline"
                buttoncolor="white"
                to="https://www.oncf-voyages.ma/recherche-disponibilites"
                class="sc-jzJRlG gKJDKb"
          ...
          <div class="sc-hORach fSFSbn">
            <div class="sc-bMVAic fcmRnv">
              Flex/Semi Flex, on vous explique tout…
            </div>
            <div class="sc-bAeIUo gEZTEr">
              <a
                buttonstyle="fill"
                buttoncolor="green"
                to="https://www.oncf-voyages.ma/faq#apres-vente"
                class="sc-jzJRlG bUqimp"
