...
const Items = () => {
  const ListVoyage = [
    { id: 1, name: "Tange", itemsVoyage: "voyage1" },
    { id: 2, name: "Tange1", itemsVoyage: "voyage2" },
    ,
    { id: 3, name: "Tang2", itemsVoyage: "voyage3" },
  ];
              ...
              >
                ...
                >
                  <div className="sc-kafWEX frzQon">
                    ...
                    <div className="sc-iELTvK eZckQM">
                      {item.itemsVoyage}Depuis Kenitra
                    </div>
                  </div>
