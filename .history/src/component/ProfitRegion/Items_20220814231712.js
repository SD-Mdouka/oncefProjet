  ...
  return (
    <div className="accordion_container">
      ...
      >
        ...
        <a
          class="sc-cIShpX iIUvbp"
          href="/recherche-disponibilites?depart=229&amp;arrivee=303"
        >
          <div class="sc-kafWEX frzQon">
            <div class="sc-feJyhm ggVxCV">
              <div>
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="sc-iELTvK eZckQM">Depuis Rabat</div>
          </div>
          <div class="sc-cmTdod bjlyHF">
            <div class="sc-jwKygS jOMxiX">à partir de</div>
            <div class="sc-btzYZH hUjbuY">89 Dhs</div>
          </div>
        </a>
        <a
          class="sc-cIShpX iIUvbp"
        ...
        >
          <div class="sc-kafWEX frzQon">
            ...
            <div class="sc-iELTvK eZckQM">Depuis Casablanca</div>
          </div>
          <div class="sc-cmTdod bjlyHF">
            <div class="sc-jwKygS jOMxiX">à partir de</div>
            <div class="sc-btzYZH hUjbuY">89 Dhs</div>
