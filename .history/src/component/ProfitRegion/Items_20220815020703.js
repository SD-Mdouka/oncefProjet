...
const ListVoyage = [
  { id: 1, name: { id: 1, nameNOde: "Tange" }, itemsVoyage: "voyage" },
  { id: 2, name: { id: 1, nameNOde: "Tange2" }, itemsVoyage: "voyage" },
  ,
  { id: 3, name: { id: 1, nameNOde: "Tange3" }, itemsVoyage: "voyage" },
];
        ...
        return (
          <>
            <div className="accordion_container ">
              <div className="accordion styleContent flex flex-col">
